...
namespace Nomina.Domain.Tests.Rules
{
    public class ContratoLaboralRulesTests
    {
        ...
        public void TestValidarCamposObligatorios_CamposVacios()
        {
            ...
            var ex = Assert.Throws<ArgumentException>(() => ContratoLaboralRules.ValidarCamposObligatorios(contrato));
        ...
        public void TestValidarFechas_FechaFinMenorQueInicio()
        {
            ...
            var ex = Assert.Throws<ArgumentException>(() => ContratoLaboralRules.ValidarFechas(contrato));
        ...
        public void TestValidarFechaInicio_FechaInicioPasada()
        {
            ...
            var ex = Assert.Throws<ArgumentException>(() => ContratoLaboralRules.ValidarFechaInicio(contrato));
        ...
        {
            var ex = Assert.Throws<InvalidOperationException>(() => ContratoLaboralRules.ValidarContratoDuplicado(true));
        ...
        {
            var ex = Assert.Throws<ArgumentException>(() => ContratoLaboralRules.ValidarMotivoHistorial(""));
        ...
        {
            var ex = Assert.Throws<InvalidOperationException>(() => ContratoLaboralRules.ValidarEdicionPorEstado("I"));
        ...
        {
            var ex = Assert.Throws<InvalidOperationException>(() => ContratoLaboralRules.ValidarReactivacion("A", "A"));
        ...
        public void TestValidarFechas_FechaFinMayorQueInicio()
        {
            ...
            var ex = Record.Exception(() => ContratoLaboralRules.ValidarFechas(contrato));
            Assert.Null(ex);
        }
        ...
        public void TestValidarFechaInicio_FechaInicioCorrecta()
        {
            ...
            var ex = Record.Exception(() => ContratoLaboralRules.ValidarFechaInicio(contrato));
            Assert.Null(ex);
        }
        ...
        {
            var ex = Record.Exception(() => ContratoLaboralRules.ValidarContratoDuplicado(false));
            Assert.Null(ex);
        }
        ...
        {
            var ex = Record.Exception(() => ContratoLaboralRules.ValidarMotivoHistorial("Cambio de salario por desempeño."));
            Assert.Null(ex);
        }
        ...
        {
            var ex = Record.Exception(() => ContratoLaboralRules.ValidarEdicionPorEstado("A"));
            Assert.Null(ex);
        }
        ...
        {
            var ex = Record.Exception(() => ContratoLaboralRules.ValidarReactivacion("S", "A"));
            Assert.Null(ex);
        }
    }
}
